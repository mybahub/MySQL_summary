...
<table>
 ...
 <tr>
  ...
  <tr>
	  <td rowspan=4 align="center">consecutive id</td>
	  <td rowspan=3 align="center">id-row_number()+group by</td>
...
<tr>
 ...
 <td> 	<a href="100-1000/603.Consecutive_available_seats.sql">Sol</a> </td>
</tr>
 <tr>
...
### 2.5 CASE WHEN [608](100-1000/608.Tree_node.sql)
